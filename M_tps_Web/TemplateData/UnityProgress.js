function UnityProgress (dom) {
	...
	logoImage.src = "https://dl.dropboxusercontent.com/M_tps_Web/TemplateData/Logo." + splashStyle + ".png"; 
	logoImage.style.position = "absolute";
	parent.appendChild(logoImage);
	this.logoImage = logoImage;

	var progressFrame = document.createElement("img");
	progressFrame.src = "https://dl.dropboxusercontent.com/M_tps_Web/TemplateData/ProgressFrame." + splashStyle + ".png"; 
	...
	progressBarImg.src = "https://dl.dropboxusercontent.com/M_tps_Web/TemplateData/ProgressBar." + splashStyle + ".png"; 
